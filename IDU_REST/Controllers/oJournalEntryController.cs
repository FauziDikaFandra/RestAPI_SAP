...
{
    public class oJournalEntryController : ApiController
    {
        // GET api/ojournalentry
        public IEnumerable<string> Get()
        {
            return new string[] { "value1", "value2" };
        }

        // GET api/ojournalentry/5
        public string Get(int id)
        {
            return "value";
        }

        // POST api/ojournalentry
        public RTNMANVAL Post([FromBody]JE value)
        {
            ...
            try
            {
                ...
                newKey = Logic.SAP.SAP_JE2.AddData(oCompany, value);
        ...
        // PUT api/ojournalentry/5
        public void Put(int id, [FromBody]string value)
        {
        }

        // DELETE api/ojournalentry/5
