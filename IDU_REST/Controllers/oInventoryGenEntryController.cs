...
namespace IDU_REST.Controllers
{
    ...
    public class oInventoryGenEntryController : ApiController
    {
        public string Get()
        {
        ...
        public RTNVAL Get(int id)
        {
            ...
            try
            {
                ...
                GR_HEADER model = Logic.SAP.SAP_GR.GetData(oCompany, id);
                int count = 0;
        ...
        // PUT api/values/5
        public string Put(int id, [FromBody]GR_HEADER value)
        {
            return "Function is not available";
        }
