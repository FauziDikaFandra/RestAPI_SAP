...
namespace IDU_REST.Controllers
{
    ...
    public class oPurchaseInvoiceController : ApiController
    {
        public string Get()
        {
        ...
        // POST api/values
        public RTNMANVAL Post([FromBody]APINV_HEADER value)
        {
            ...
            try
            {
                ...
                newKey = Logic.SAP.SAP_APINV.AddData(oCompany, value);
